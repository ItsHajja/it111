public class MyVariable1 {
 ...
 String name = "Hajja"; // after a statement don't forget the semi colon!
        int hours = 40; // we are assigning 40 to the hours variable
        // Please note, when we have a string value, it is nest in ""
...
//        String building = "Columbia Tower", tree = "Mango", lake = "Lake Lanier", ocean = "Atlantic Ocean";
